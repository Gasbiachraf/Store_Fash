        ...
        <>
            ...
            <div className={` ${boolean ? 'block' : 'hidden'}`}>
                <div className='shadow-xl rounded-lg bg-white mt-[8.9vh] max-[430px]:mt-[11vh] max-[430px]:w-[70%] w-[25%] h-[71vh] fixed z-10 right-2 p-5'>
                    ...
                    <p className='text-end pt-4'>Subtotal : $100.00</p>
                    <div className='pt-8 flex justify-between'>
                        <button className='bg-[#111111] text-white py-2 max-[430px]:text-sm max-[430px]:px-6 px-10 rounded-full hover:bg-red-600 duration-300'>VIEW CART</button>
                        <button className='bg-[#111111] text-white py-2 max-[430px]:text-sm max-[430px]:px-6 px-10 rounded-full hover:bg-red-600 duration-300'>VIEW CART</button>
                    </div>
